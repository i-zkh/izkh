class MyBoxProcessor < BillingProcessor
URL = "https://paymentsystem.mb-samara.ru/cgi-bin/pay/"
...
protected
  ...
  def check_url
    url = "ok_pay_step1?agreement_number$i=#{@number}&agreement_type$i=#{@type}&cash_type$i=1"
    "#{URL}#{url}"
  end
